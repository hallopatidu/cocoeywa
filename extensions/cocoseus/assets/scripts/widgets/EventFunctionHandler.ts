...
export interface IEventFunctionHandler extends Component {
    listen(node:Node):void,
    refreshEventHanders?():void,
}
export interface IEventFunctionHandlerStatic {
}

/**
 * 
 */
export const EventFunctionHandlerClassName:string = "EventFunctionHandler";
export default cocoseus.CCClassify<IEventFunctionHandler, Constructor<IEventFunctionHandler>>(function eventFunctionHandler<TBase=Component>(base:Constructor<TBase&IEventFunctionHandler>):Constructor<TBase & IEventFunctionHandler>{
    class EventFunctionHandler extends (base as unknown as Constructor<IEventFunctionHandler>)implements IEventFunctionHandler{
        ...
        [AddAllRegisterEvents](){
            ...
            listOfOverrideMethods && listOfOverrideMethods.forEach((eventAddedCommand:string)=>{
                ...
                // this.node.on(eventName, this[eventName], this);
            })
        }
    ...
    return EventFunctionHandler as unknown as Constructor<TBase & IEventFunctionHandler>;
